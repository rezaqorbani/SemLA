...
class Attention(nn.MultiheadAttention):
    ...
    def __init__(self, *args, **kwargs):
        ...
        #=========================================================================
        # Convert q,k,v proj matrices to Linear modules to attach LoRAs using PEFt
        self.q_proj = nn.Linear(self.embed_dim, self.embed_dim, bias=False)
        self.k_proj = nn.Linear(self.embed_dim, self.embed_dim, bias=False)
        self.v_proj = nn.Linear(self.embed_dim, self.embed_dim, bias=False)
        
        self.q_proj.weight = self.q_proj_weight
        self.k_proj.weight = self.k_proj_weight
        self.v_proj.weight = self.v_proj_weight
        #=========================================================================
...
class ResidualAttentionBlock(nn.Module):
    ...
    def forward_dense(self, x: torch.Tensor, prompt=None):
        ...
        if self.attn.in_proj_weight is not None:
            ...
            #=========================================================================
            # Using the weights of Linear projection matrices to avoid memory leak
            proj = torch.cat((self.attn.q_proj.weight, self.attn.k_proj.weight, self.attn.v_proj.weight), dim=0)
            #=========================================================================
