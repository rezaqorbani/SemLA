...
MUSES_CLEAR_DAY_SPLITS = {
    "muses-clear-day_{task}_train": ("muses/frame_camera/train/clear/day/",
                                    "muses/gt_semantic/train/clear/day/"),
    "muses-clear-day_{task}_val": ("muses/frame_camera/val/clear/day/",
                                    "muses/gt_semantic/val/clear/day/"),
}

def register_muses_clear_day(root):
    for key, (image_dir, gt_dir) in MUSES_CLEAR_DAY_SPLITS.items():
...
register_muses_clear_day(_root)