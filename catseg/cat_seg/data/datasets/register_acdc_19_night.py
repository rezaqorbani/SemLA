...
ACDC_NIGHT_SPLITS = {
    "acdc-night_{task}_train": ("acdc/rgb_anon/night/train/",
                                    "acdc/gt/night/train/"),
    "acdc-night_{task}_val": ("acdc/rgb_anon/night/val/",
                                    "acdc/gt/night/val/"),
    "acdc-night_{task}_test": ("acdc/rgb_anon/night/test/",
                                    "acdc/gt/night/test/"),
}

def register_acdc_night(root):
    for key, (image_dir, gt_dir) in ACDC_NIGHT_SPLITS.items():
