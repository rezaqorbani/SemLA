...
ACDC_SNOW_SPLITS = {
    "acdc-snow_{task}_train": ("acdc/rgb_anon/snow/train/",
                                    "acdc/gt/snow/train/"),
    "acdc-snow_{task}_val": ("acdc/rgb_anon/snow/val/",
                                    "acdc/gt/snow/val/"),
    "acdc-snow_{task}_test": ("acdc/rgb_anon/snow/test/",
                                    "acdc/gt/snow/test/"),
}

def register_acdc_snow(root):
    for key, (image_dir, gt_dir) in ACDC_SNOW_SPLITS.items():
