...
MUSES_SNOW_DAY_SPLITS = {
    "muses-snow-day_{task}_train": ("muses/frame_camera/train/snow/day/",
                                    "muses/gt_semantic/train/snow/day/"),
    "muses-snow-day_{task}_val": ("muses/frame_camera/val/snow/day/",
                                    "muses/gt_semantic/val/snow/day/"),
}

def register_muses_snow_day(root):
    for key, (image_dir, gt_dir) in MUSES_SNOW_DAY_SPLITS.items():
