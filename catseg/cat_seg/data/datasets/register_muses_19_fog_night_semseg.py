...
MUSES_FOG_NIGHT_SPLITS = {
    "muses-fog-night_{task}_train": ("muses/frame_camera/train/fog/night/",
                                    "muses/gt_semantic/train/fog/night/"),
    "muses-fog-night_{task}_val": ("muses/frame_camera/val/fog/night/",
                                    "muses/gt_semantic/val/fog/night/"),
}

def register_muses_fog_night(root):
    for key, (image_dir, gt_dir) in MUSES_FOG_NIGHT_SPLITS.items():
...
register_muses_fog_night(_root)