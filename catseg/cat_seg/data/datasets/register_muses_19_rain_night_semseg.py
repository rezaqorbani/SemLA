...
MUSES_RAIN_NIGHT_SPLITS = {
    "muses-rain-night_{task}_train": ("muses/frame_camera/train/rain/night/",
                                    "muses/gt_semantic/train/rain/night/"),
    "muses-rain-night_{task}_val": ("muses/frame_camera/val/rain/night/",
                                    "muses/gt_semantic/val/rain/night/"),
}

def register_muses_rain_night(root):
    for key, (image_dir, gt_dir) in MUSES_RAIN_NIGHT_SPLITS.items():
...
register_muses_rain_night(_root)