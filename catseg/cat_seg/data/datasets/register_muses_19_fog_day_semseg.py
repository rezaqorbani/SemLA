...
MUSES_FOG_DAY_SPLITS = {
    "muses-fog-day_{task}_train": ("muses/frame_camera/train/fog/day/",
                                    "muses/gt_semantic/train/fog/day/"),
    "muses-fog-day_{task}_val": ("muses/frame_camera/val/fog/day/",
                                    "muses/gt_semantic/val/fog/day/"),
}

def register_muses_fog_day(root):
    for key, (image_dir, gt_dir) in MUSES_FOG_DAY_SPLITS.items():
