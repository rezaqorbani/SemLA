...
MUSES_RAIN_DAY_SPLITS = {
    "muses-rain-day_{task}_train": ("muses/frame_camera/train/rain/day/",
                                    "muses/gt_semantic/train/rain/day/"),
    "muses-rain-day_{task}_val": ("muses/frame_camera/val/rain/day/",
                                    "muses/gt_semantic/val/rain/day/"),
}

def register_muses_rain_day(root):
    for key, (image_dir, gt_dir) in MUSES_RAIN_DAY_SPLITS.items():
