...
MUSES_SNOW_NIGHT_SPLITS = {
    "muses-snow-night_{task}_train": ("muses/frame_camera/train/snow/night/",
                                    "muses/gt_semantic/train/snow/night/"),
    "muses-snow-night_{task}_val": ("muses/frame_camera/val/snow/night/",
                                    "muses/gt_semantic/val/snow/night/"),
}

def register_muses_snow_night(root):
    for key, (image_dir, gt_dir) in MUSES_SNOW_NIGHT_SPLITS.items():
...
register_muses_snow_night(_root)